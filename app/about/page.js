...
export default function Page() {
  return (
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      {/* If we have an image and we don't want to give any dimensions,we place the dimensions inside the parent element and specify height and width of the parent. */}
